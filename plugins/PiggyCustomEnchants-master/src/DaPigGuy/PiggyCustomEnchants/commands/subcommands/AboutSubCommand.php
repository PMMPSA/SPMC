...
class AboutSubCommand extends BaseSubCommand
{
    ...
    {
        $message = TextFormat::GREEN . "PiggyCustomEnchants version " . TextFormat::GOLD . PiggyCustomEnchants::getInstance()->getDescription()->getVersion() . TextFormat::EOL .
        ...
        if ($sender instanceof Player && PiggyCustomEnchants::getInstance()->areFormsEnabled()) {
            $form = new SimpleForm(function (Player $player, ?int $data): void {
                if ($data !== null) {
                    PiggyCustomEnchants::getInstance()->getServer()->dispatchCommand($player, "ce");
                }
            });
